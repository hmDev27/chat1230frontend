...
const LoginPage = () => {
  ...
  return (
   ...
   <div className="h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">欢迎使用,请登录</h1>
              <p className="text-base-content/60">အကောင့်Log inဝင်ပါ</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        title={"ပြန်လှယ်ကြိုဆိုပါတယ်!"}
        subtitle={"လော့အင်ဝင်ပြီး သင်၏ချက်တင်များသို့ပြန်သွားပါ။"}
      />
    </div>
  )
